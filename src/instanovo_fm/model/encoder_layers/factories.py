...
def create_unified_encoder_stack(
    ...
    """
    from .unified_encoder import UnifiedEncoderLayer, UnifiedTransformerEncoder, BatchedPairwiseProjection, SharedPairwiseProjection
    ...
    pairwise_bias = None
    if arch_config['bias_type'] in ('pa', 'alibi_pa'):
        pairwise_bias = create_relative_bias(
            'pa',
            n_heads,
            d_model,
    ...
    logger.debug(f"Unified encoder: pos_encoding={arch_config['pos_type']}, "
