...
class PadTokenMixin:
    ...
    def setup_pad_token(self, cfg: dict, dim_model: int) -> None:
        ...
        if self.use_flash_attention:
            ...
            # through, see Encoder Contract in instanovo_fm/CLAUDE.md
            ...
            self.pad_token = nn.Parameter(torch.randn(1, 1, dim_model), requires_grad=False)
        else:
